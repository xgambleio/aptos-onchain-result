...
public final class Ed25519PublicKey {
    ...
    public Ed25519PublicKey(Bytes value) {
        java.util.Objects.requireNonNull(value, "value must not be null");
        this.value = value;
    }

    public static Ed25519PublicKey deserialize(Deserializer deserializer) throws DeserializationError {
    ...
    public static Ed25519PublicKey bcsDeserialize(byte[] input) throws DeserializationError {
        if (input == null) {
