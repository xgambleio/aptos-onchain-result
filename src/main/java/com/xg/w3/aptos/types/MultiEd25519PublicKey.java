...
public final class MultiEd25519PublicKey {
    ...
    public MultiEd25519PublicKey(Bytes value) {
        java.util.Objects.requireNonNull(value, "value must not be null");
        this.value = value;
    }

    public static MultiEd25519PublicKey deserialize(Deserializer deserializer) throws DeserializationError {
    ...
    public static MultiEd25519PublicKey bcsDeserialize(byte[] input) throws DeserializationError {
        if (input == null) {
