...
import com.xg.w3.aptos.bean.Pair;
import com.xg.w3.aptos.bean.Triple;
import com.xg.w3.aptos.types.AccountAddress;
import com.xg.w3.aptos.types.Identifier;
import com.xg.w3.aptos.types.TypeInfo;
...
public class StructTagUtils {
    ...
    public static com.xg.w3.aptos.types.TypeTag toTypeTag(String s) {
    ...
    public static com.xg.w3.aptos.types.TypeTag toTypeTag(String structAddress, String structModule, String structName) {
        com.xg.w3.aptos.types.TypeTag tt = new com.xg.w3.aptos.types.TypeTag.Struct(new com.xg.w3.aptos.types.StructTag(
    ...
    public static TypeInfo toTypeInfo(StructTag t) {
    ...
    public static com.xg.w3.aptos.bean.TypeInfo toTypeInfoBean(StructTag t) {
        com.xg.w3.aptos.bean.TypeInfo typeInfo = new com.xg.w3.aptos.bean.TypeInfo();
